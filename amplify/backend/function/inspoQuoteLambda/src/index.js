...
exports.handler = async (event) => {
    ...
    async function getRandomQuote(apiURLInput) {
        ...
        const svgImage = `
            <svg width = "${width}" height = "${height}">
                ...
                <g>
                    ...
                    <text id="lastLineOfQuote" x="375" y="70" text-anchor="middle" font-size="35" font-family="Verdana" fill="white">
                        ${tspanElements}
                    <tspan class="quoteAuthorStyles" x="375" dy="1.8em">- ${quoteAuthor}</tspan>
                </text>
                </g>
                <text x="${width / 2}" y="${height - 10}" class="footerStyles">
                Developed by Eugene Tye | Quotes from ZenQuotes.io
                </text>
            </svg>
        `;
        ...
        const backgroundImages = [
            "backgrounds/Deep-Purple.png",
            "backgrounds/A-Lost-Memory.png",
            "backgrounds/Mojito.png",
